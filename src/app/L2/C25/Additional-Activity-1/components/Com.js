...
export default function Com() {
    ...
    const obj = [
        {
            question: "Marta did not give up when the drought hit. What leadership quality does this show?",
            answer: "Resilience"
        },
        {
            question: "Marta made sure everyone got a fair share of the food. What leadership quality does this demonstrate?",
            answer: "Fairness"
        },
        {
            question: "The villagers trusted Marta because she always helped and listened to them. What quality made her a great leader?",
            answer: "Integrity"
        },
        {
            question: "Can you think of a time when you helped someone without being asked? How did it make you feel?",
            answer: ""
        }
    ];
        ...
        <div className="flex p-6">
            <div className="w-1/2">
                <video
                    ...
                    controls
                    src="/assets/L2-C25/Additional-Activity-1/v1.mp4"
                ></video>
            </div>
